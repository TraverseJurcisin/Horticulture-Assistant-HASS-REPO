...
@pytest.mark.asyncio
async def test_async_create_profile_deduplicates_sequence_sensor_parameters(hass, tmp_path, monkeypatch) -> None:
    """Explicit sensor sequences should drop duplicate entries while preserving order."""
