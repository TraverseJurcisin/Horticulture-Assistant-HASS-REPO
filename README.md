...
- `electricity_rates.json` – average electricity cost per kWh by region
- `electricity_rates_monthly.json` – monthly electricity rates for finer grained cost estimates
