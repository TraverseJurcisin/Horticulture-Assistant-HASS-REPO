...
class SensorHealthBinarySensor(HorticultureBaseBinarySensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = self.profile_unique_id("sensor_health")
...
class IrrigationReadinessBinarySensor(HorticultureBaseBinarySensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = self.profile_unique_id("irrigation_readiness")
...
class FaultDetectionBinarySensor(HorticultureBaseBinarySensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = self.profile_unique_id("fault_detection")
