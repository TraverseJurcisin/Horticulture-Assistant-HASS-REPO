...
def main(argv: list[str] | None = None) -> None:
    ...
    actual.add_argument("--cost", action="append", type=float, default=[], help="Additional cost")

    exp = sub.add_parser("expected", help="Profit from yield estimate")
    exp.add_argument("plant_type", help="Crop type")
    exp.add_argument("--extra-cost", action="append", type=float, default=[], help="Extra cost")
