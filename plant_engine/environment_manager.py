...
def evaluate_humidity_stress(humidity_pct: float | None, plant_type: str) -> str | None:
    """Return 'low' or 'high' if humidity is outside the plant range."""

    if humidity_pct is None:
        return None

    bounds = _HUMIDITY_THRESHOLDS.get(
